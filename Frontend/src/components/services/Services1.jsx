                  ...
                  <div key={i} className="col-lg-6 d-flex align-items-center">
                    <div className="software_banner_content">
                      ...
                      <p
                        ...
                        className="service_p"
                      >
                        BAZRA connect technology needs of clients for maximum business and personal exploitation supported with state of the art automotive and information technology. At BAZRA, we are dedicated to providing cutting-edge solutions tailored to meet the unique needs of the client in the automotive, agricultural machinery and IT arena. Our comprehensive range of services is designed to empower businesses and drive success in a rapidly evolving economic landscape.                 </p>
                      <div

...
const Contact = () => {
  ...
  return (
    ...
    <img alt="Get in touch" class="bancontact_shap lazyloaded" src={item.cover}/>    
      ...
      <div>
          <iframe title="Map" width="100%" height="400" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Friendship%20International%20Hotel,%20Bole,%20Addis%20Ababa+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
